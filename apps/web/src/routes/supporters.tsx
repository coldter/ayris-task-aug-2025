  ...
  const fetchUsers = useCallback(async () => {
    try {
      ...
      if (res.error) {
        ...
        setUsers([]);
        setTotal(0);
        toast.error(res.error.message || "Failed to load supporters");
        return;
      }
      ...
      <div className="mt-8">
        <Card>
          ...
          <CardFooter>
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  await authClient.admin.createUser(
                    { email, password, name, role: "support" },
                    {
                      onSuccess: () => {
                      ...
                      onError: (error) => {
                        toast.error(
                          error.error.message || "Failed to create supporter",
                        );
                      },
                    },
                  );
            ...
            >
              {submitting ? "Creating..." : "Create Supporter"}
            </Button>
          </CardFooter>
        </Card>
      </div>
